...
public final class FragmentAccountBinding implements ViewBinding {
  ...
  private FragmentAccountBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static FragmentAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAccountBinding((ConstraintLayout) rootView, textView);
    }
