...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawer,
      ...
      @NonNull MaintoolbarBinding toolbar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaintoolbarBinding binding_toolbar = MaintoolbarBinding.bind(toolbar);

      return new ActivityMainBinding((DrawerLayout) rootView, drawer, navHostFragment,
          navigationView, binding_toolbar);
    }
